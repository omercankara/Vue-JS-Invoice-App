...
const props = defineProps({ items: Array})
        ...
        const subTotal  = computed(() => props.items.reduce((t,  i ) => t + i.total_price, 0)) //t toplam i ise item
        const taxTotal  = computed(() => subTotal.value * 0.18) //kdvyi bul
        const total  = computed(() => subTotal.value + taxTotal.value) //t toplam i ise item
